...
from philote_mdo.csdl import RemoteExplicitOperation


@patch('openmdao.api.ExplicitComponent.__init__')
class TestCsdlExplicitClient(unittest.TestCase):
    """
    Unit tests for the CSDL explicit component/client.
    """

    @patch('philote_mdo.general.ExplicitClient')
    def test_constructor(self, mock_explicit_client, mock_custom_explicit_operation):
        """
        ...
        comp = RemoteExplicitOperation(channel=mock_channel, **options)
        ...
        # mock_custom_explicit_operation.assert_called_with(**options)
    ...
    def test_initialize(self, om_explicit_operation_patch):
        mock_channel = Mock()
        ...
        # create an instance of the class
        comp = RemoteExplicitOperation(channel=mock_channel)
    ...
    def test_setup(self, mock_openmdao_client_setup, om_explicit_component_patch):
        ...
        mock_channel = Mock()
        component = RemoteExplicitOperation(channel=mock_channel)
    ...
    def test_compute(self, om_explicit_component_patch):
        ...
        mock_channel = Mock()
        instance = RemoteExplicitOperation(channel=mock_channel)
    ...
    def test_compute_partials(self, om_explicit_component_patch):
        ...
        # Creating instance of the class to be tested
        instance = RemoteExplicitOperation(channel=Mock())
        instance._client = client_mock
        # mock the component name
        instance.name = 'test'
